<template>
  <div>
    ...
    <div class="flex items-center mb-4 space-x-4">
      <div>
        <button
          :class="['px-4 py-2 rounded-md font-semibold', activeTab === 'active' ? 'bg-gray-300' : 'bg-gray-100']"
          @click="activeTab = 'active'"
        >
          Active
        </button>
        <button
          :class="['px-4 py-2 rounded-md font-semibold', activeTab === 'inactive' ? 'bg-gray-300' : 'bg-gray-100']"
